...
> **🔗 Live demo:** https://agent-sre-389498242223.us-central1.run.app (password provided in the
> Devpost submission notes — a light bot-deterrent, set via `APP_PASSWORD`).
...
> (`healthy ❌ → paged ✅`), then Guard 4/4 and Prevent.
